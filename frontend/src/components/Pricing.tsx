    ...
    return (
        ...
        >
            <div className="max-w-3xl mx-auto px-4 text-center font-[Montserrat]">
                ...
                {/* Label */}
                <span className="inline-block text-xs font-bold tracking-widest uppercase mb-4 px-3 py-1 rounded-full bg-indigo-100 text-indigo-700">
                    Best Value Package
                </span>
                ...
                <div className="rounded-2xl p-8 md:p-10 mb-8 border bg-white shadow-lg">
                    ...
                    <p className="text-gray-600 text-sm">
                        5 Nights 6 Days | Munnar · Alleppey/Kumarakom Houseboat · Kovalam
                    </p>
                ...
                <div className="space-y-2 mb-8">
                    ...
                    <div className="flex items-center justify-center gap-2 text-gray-600 text-sm">
                        <TrendingUp className="w-4 h-4 flex-shrink-0 text-indigo-600" />
